...
LinqFaster now includes all relevant Linq extension methods, and many **SIMD** and **parallel** enhanced extension methos are available as well in separate projects and nuget packages.  The projects have no depdencies on each other so you can pick and choose at will.
